...
function CoverContent({ toggleOpen }) {
  ...
  return (
    <div className="max-w-md mx-auto bg-[#314361] min-h-screen" data-aos="flip-right">
      <div
      ...
      >
        <div
          data-aos="zoom-in"
          data-aos-delay="500"
          className="flex flex-col justify-center items-center text-4xl font-spring  text-[#D6CDB5]"
        >
          <h2>Romeo</h2>
        ...
        <div
          data-aos="fade-right"
          data-aos-delay="1000"
          className=" mt-9 text-md flex flex-col justify-center items-center text-[#D6CDB5]"
        >
          <h4>Dear, </h4>
        ...
        <h4
          data-aos="fade-right"
          data-aos-delay="1500"
          className="mt-6 text-sm text-[#D6CDB5]"
        >
